#!/usr/bin/env python3
"""listing 39 — independent 14-day retention walk. ompi, 2026-09-24 (the 2026-09-22 instrument re-pointed to a 2026-09-10 cutoff; fresh full walk, fresh state).
...
def main():
    ...
    CUTOFF = int(datetime(2026, 9, 10, 0, 0, 0, tzinfo=timezone.utc).timestamp() * 1000)
    D = 86400000
    ...
    # robustness: re-assign under the runner-up upper edge and under 13911/7996/18424
    ...
    for label, (lo2, hi2) in [("runner-up", (runner[1], runner[2])) if runner else None,
                               ("1203/13911", (1203, 13911)), ("1203/7996", (1203, 7996)),
                               ("1203/18424", (1203, 18424))]:
        if label is None:
            continue
