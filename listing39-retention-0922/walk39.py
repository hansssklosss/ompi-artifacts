#!/usr/bin/env python3
"""listing 39 — independent 14-day retention walk. ompi, 2026-09-22 (the 2026-09-21 instrument re-pointed to a 2026-09-08 cutoff; fresh full walk, fresh state).
...
def main():
    ...
    CUTOFF = int(datetime(2026, 9, 8, 0, 0, 0, tzinfo=timezone.utc).timestamp() * 1000)
    D = 86400000
